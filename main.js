document.addEventListener('DOMContentLoaded', () => {
            ...
            <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
                <tr>
                    ...
                    <td style="width:50%; vertical-align:top; text-align:right;">
                        <h2 style="margin:0 0 10px 0; font-size:22px; color:#666; font-weight:normal;">COTIZACIÓN</h2>
                        <table style="width:200px; float:right; border-collapse:collapse; font-size:11px; text-align:right;">
                            ...
                            <tr><td style="padding:2px 5px;">COTIZACIÓN #</td><td style="border:1px solid #000; padding:2px 5px; text-align:center;">${cot.codigo}</td></tr>
                ...
                <tr>
                    <td style="width:60%; vertical-align:top; padding-right:20px;">
                        ...
                        <div style="border:1px solid #333; padding:5px; font-size:11px; line-height:1.5;">
                            ...
                            3. Plazo de entrega 5 días recibida OC.
                        </div>
                    </td>
    ...
    window.saveBid = function() {
        ...
        alert('Licitaci�n guardada exitosamente en el Repositorio de Participaciones.');
    ...
    window.renderBidsTable = function() {
        ...
        if (bids.length === 0) {
            tbody.innerHTML = '<tr><td colspan="6" style="padding: 2rem; text-align: center; color: var(--text-muted);">No tienes licitaciones guardadas a�n.</td></tr>';
            return;
        }
    ...
    window.deleteBid = function(codigo) {
        if (!confirm('�Seguro que deseas eliminar esta postulaci�n del repositorio?')) return;
        let bids = [];
        try { bids = JSON.parse(localStorage.getItem('my_bids')) || []; } catch(e){}
